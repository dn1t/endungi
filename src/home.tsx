        ...
        <>
          <section className='overflow-x-auto'>
            <div className='flex items-center max-w-5xl mx-auto px-5 sm:px-10 xl:px-0 py-24'>
              ...
              <img src={MainBannerImage} className='ml-auto h-48 lg:h-56 hidden md:block' alt='' />
            </div>
          </section>

          <section className='max-w-5xl mx-auto px-5 sm:px-10 xl:px-0 py-8'>
            <h2 className='font-bold text-black dark:text-slate-200 text-2xl'>주목할 만한 엔둥이</h2>
                    ...
                    >
                      {recommendedUsers ? (
                        <div
                          ...
                          style={{ backgroundImage: `url('${recommendedUser.profileImage}')` }}
                        />
                      ) : (
